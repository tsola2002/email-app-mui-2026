      ...
      <>
        ...
        >
          ...
          <List>
            ...
            <ListItemButton sx={{ color: "#B3B3B3", mt: 2, "&:hover": { bgcolor: "#EAFAF7" } }} onClick={() => navigate("/company-Dashboard")}>
              <ListItemIcon sx={{ color: "#B3B3B3" }}>
                <ApartmentIcon />
              </ListItemIcon>
            ...
            <ListItemButton sx={{ color: "#B3B3B3", mt: 2, "&:hover": { bgcolor: "#EAFAF7" } }}>
              ...
              <ListItemText primary="Blocked E-mail" slotProps={{ primary: { fontSize: 14 } }} onClick={() => navigate("/BlockedEmail")}/>
            </ListItemButton>

          </List>

          <ListItemButton sx={{ color: "#B3B3B3", mt: "auto", "&:hover": { bgcolor: "#EAFAF7" } }}>
          <ListItemIcon sx={{ color: "#B3B3B3" }}>
            <DeleteIcon />
          </ListItemIcon>
          <ListItemText primary="Trash" slotProps={{ primary: { fontSize: 14 } }} onClick={() => navigate("/Trash")}/>
        </ListItemButton>
        ...
        <ListItemButton sx={{ color: "#B3B3B3", mt: "10rem", "&:hover": { bgcolor: "#EAFAF7" } }}>
          ...
          <ListItemText primary="Log Out" slotProps={{ primary: { fontSize: 14 } }} onClick={() => navigate("/logout")}/>
        </ListItemButton>
      </Box >
    ...
    alignItems: "center",
      gap: 1,
        ml: 0,
            ...
            <Typography sx={{ fontSize: 12, fontWeight: 600, color: "#E2CB00" }}>
              COULD NOT RESPOND
            </Typography>
          </Box >
          ...
          <Box sx={{ mt: 1 }}>
            ...
            <Typography
              sx={{
                ...
                fontSize: 14,
                fontWeight: 600,
                mb: 1, // space between title and box
              }}
            >
            ...
            >
              ...
              >
                Invalid or missing customer details. The system could not find sufficient
                information about the customer to generate an automatic response.
              </Typography>
            </Box>
          </Box>
